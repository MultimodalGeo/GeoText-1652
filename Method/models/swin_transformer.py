...
class SwinTransformer(nn.Module):
    ...
    # def forward(self, x, idx_to_group_img=None, image_atts=None, feature_map=False,  size=None, **kwargs):
    ...
    #     if feature_map==True:
    #         print("Returning feature map")
    #         features_before_avgpool_reshaped =tt.reshape(1, size, size, 1024)
    #         return (features_before_avgpool_reshaped)
